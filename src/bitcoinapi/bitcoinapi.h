...
#include "types.h"
#include "exception.h"
#include "../../lib/cpphttplibconnector.hpp"
...
private:
    unique_ptr<CppHttpLibClientConnector> httpClient;
    unique_ptr<jsonrpccxx::JsonRpcClient> client;

public:
    /* === Constructor and Destructor === */
    BitcoinAPI(const std::string &host, int port);
    ~BitcoinAPI();
